...
const BENEFITS: Record<string, ActivityBenefit> = {
  ...
  'Shoulder Socket Rotation': { primary: 'Shoulders', secondary: ['Rotator cuff', 'Upper back'] },
  'Vertical Arm Rotation': { primary: 'Shoulders', secondary: ['Lats', 'Chest'] },
  'Arm Circles': { primary: 'Shoulders', secondary: ['Upper back', 'Chest'] },
  'Hand Alternate Raise': { primary: 'Shoulders', secondary: ['Lats', 'Side body'] },
  'Hand Crossover': { primary: 'Chest', secondary: ['Shoulders', 'Upper back'] },
  ...
  Windmill: { primary: 'Hamstrings', secondary: ['Obliques', 'Shoulders', 'Spine'] },
  ...
  Relaxation: { primary: 'Recovery', secondary: ['Breath', 'Nervous system'] },
  ...
  'Crossover Arm Stretch': { primary: 'Shoulders', secondary: ['Upper back', 'Rear deltoids'] },
  'Tricep Stretch': { primary: 'Triceps', secondary: ['Shoulders', 'Lats'] },
  'Towel Stretch': { primary: 'Shoulders', secondary: ['Chest', 'Upper back'] },
  'Rotator Cuff Stretches': { primary: 'Rotator cuff', secondary: ['Shoulders', 'Upper back'] },
